...
public class ForgetPasswordActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobSDK.init(this,"31d87240e8f0f","f29fc05deb91cdb8195c5ef4e66658ed");//注册自己的
    ...
    public void ForgetPasswordRequest(final String username, final String telenum){
        //请求地址
        String url = "http://hnusit.cn:9999/server/forgetPasswordServlet";
        ...
        switch (v.getId()) {
            case R.id.check:
                ...
                if (!TextUtils.isEmpty(phone)) {
                    //定义需要匹配的正则表达式的规则
                    String REGEX_MOBILE_SIMPLE =  "[1][35789]\\d{9}";
                    //把正则表达式的规则编译成模板
