...
public class PersonDao{
    ...
    public int addOrModifyPerson(Person p,DButil dbutil) throws Exception{
    ...
    public List<Person> queAll(DButil dbutil) throws Exception{
        ...
        for(Map<String,Object>map:list){
            Integer a;
            if((Integer) map.get("age")>0) a=(Integer) map.get("age");
            else a = null;
           //person = new Person((String)map.get("username"),(String)map.get("name"),(Integer) map.get("age"),(String)map.get("teleno"));
            person = new Person((String)map.get("username"),(String)map.get("name"),a,(String)map.get("teleno"));
